...
?>
    ...
    <form method="POST" action="<?php print($_SERVER['https://telk.glitch.me/chat.php?room='.$_GET[room]]) ?>">
      <input class="sendName" type="text" spellcheck="false" name="personal_name" placeholder="ニックネームを入力" required><br>
      <textarea class="sendBody" name="contents" wrap="off" spellcheck="false" placeholder="投稿内容を入力" required></textarea><br>
